...
root = Tk()
root.title("Simple Calculator by VD")

e = Entry(root, width=45, borderwidth=5, bg="lightblue",)
...
button_equal = Button(root, text="=", padx=91, pady=20, command=button_equal,bg="lightblue" )
